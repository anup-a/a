    ...
    <main>
      ...
      <section className="relative flex flex-col items-center justify-center w-3/5 mx-auto">
        <div className="flex w-full" data-aos="fade-right">
          <h3 className="my-4 mt-12 text-lg font-bold">UI Snippets</h3>
        </div>
        <div className="w-full mt-8">
          <div className="mb-4">
            <h2 className="inline mb-6 font-normal text-slate-800">
              Word Rotater
            </h2>
            <div className="inline float-right">
              <span className="h-6 px-2 py-1 ml-2 text-xs rounded-md bg-[#ffffff45]">
                React
              </span>
              <span className="h-6 px-2 py-1 ml-2 text-xs rounded-md bg-[#ffffff45]">
                Tailwind CSS
          ...
          <div className="w-full bg-white rounded-lg">
            <div className="flex gap-2 p-4 rounded-t-lg bg-slate-800">
            ...
            <div className="p-10 min-h-[250px] flex justify-center items-center">
              <h1
                className="flex text-xl text-slate-600"
                data-aos="fade-up"
                data-aos-delay="200"
          ...
          <div className="flex items-center mt-8 ml-2">
            <button
              className="px-6 py-2 text-xs border-2 rounded-md text-slate-800 border-slate-800"
